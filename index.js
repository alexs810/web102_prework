...
// use the length of the games array to get the number of games
...
const unfundedMessage = numUnfundedGames === 0
    ? "All our games are fully funded!"
    : `There ${numUnfundedGames === 1 ? "is" : "are"} ${numUnfundedGames} game${numUnfundedGames === 1 ? "" : "s"} that ${numUnfundedGames === 1 ? "is" : "are"} still seeking funding.`;

// create a new DOM element containing the template string and append it to the description container
const descriptionElement = document.createElement("p");
descriptionElement.innerHTML = unfundedMessage;
...
firstGameElement.innerHTML = `${topGame.name}`;
